...
########################################################################################################
# First step:	Resample one arbitrary mnc csi file to magnitude.mnc resolution.
# Second step:	Resample the magnitude to CSI - if they have different angulation of slices
# Third step:	Convert this resampled magnitude to nii for BET and segmentation (FAST)
#
#	Extract brain using BET, useful bet flags:
