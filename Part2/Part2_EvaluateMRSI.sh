...
#12. Compress the CoordFiles and Spectral Files
...
echo "Copy logfile from ${logfile} to ${out_dir}/logfile_part2.log"
cp "$logfile" "${out_dir}/logfile_part2.log"
rm -R "$abs_tmp_dir"
