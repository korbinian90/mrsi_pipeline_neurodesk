...
$rawtomincp -float -clobber -like "${out_dir}/maps/Seg_temp/template_bet_pve_1.mnc" -input "${out_dir}/maps/Seg_temp/WM_CSI_map.raw" "${out_dir}/maps/Seg_temp/WM_CSI_map_tmp.mnc"
$rawtomincp -float -clobber -like "${out_dir}/maps/Seg_temp/template_bet_pve_2.mnc" -input "${out_dir}/maps/Seg_temp/GM_CSI_map.raw" "${out_dir}/maps/Seg_temp/GM_CSI_map_tmp.mnc"

# From csilate - read the information needed for mincresampling the T1
...
$minctorawp -nonormalize -float -range 0 1 "${out_dir}/maps/Seg_temp/WM_CSI_map_tmp2.mnc" >"${out_dir}/maps/Extra/WM_CSI_map_tmp.raw"
$minctorawp -nonormalize -float -range 0 1 "${out_dir}/maps/Seg_temp/GM_CSI_map_tmp2.mnc" >"${out_dir}/maps/Extra/GM_CSI_map_tmp.raw"

$rawtomincp -like "$csilate" -float -clobber -input "${out_dir}/maps/Extra/WM_CSI_map_tmp.raw" "${out_dir}/maps/Extra/WM_CSI_map.mnc"
$rawtomincp -like "$csilate" -float -clobber -input "${out_dir}/maps/Extra/GM_CSI_map_tmp.raw" "${out_dir}/maps/Extra/GM_CSI_map.mnc"

$minctorawp -nonormalize -float -range 0 1 "${out_dir}/maps/Extra/WM_CSI_map.mnc" >"${out_dir}/maps/Extra/WM_CSI_map.raw"
$minctorawp -nonormalize -float -range 0 1 "${out_dir}/maps/Extra/GM_CSI_map.mnc" >"${out_dir}/maps/Extra/GM_CSI_map.raw"
