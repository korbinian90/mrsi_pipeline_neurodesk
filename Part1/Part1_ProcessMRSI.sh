...
TerminateProgram() {
	...
	# Copy the logfile
	echo "Copy logfile to $out_path"
	cp "$logfile" "$out_path"
	cp "$tmp_dir/ErrorFile.sh" "$out_path"
...
# read -rp "Stop before MRSI_Reconstruction.m"
# 6.
