...
================================
-flip_mask 
-run_flip_mask.sh (shell script for temporarily setting environment variables and 
   ...
   -to run the shell script, type
    ...
    run the shell script as:
       ...
       ./run_flip_mask.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2023a/runtime/glnxa64:MR/R2023a/bin/glnxa64:MR/R2023a/sys/os/glnxa64:MR/R2023a/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_flip_mask.sh 
